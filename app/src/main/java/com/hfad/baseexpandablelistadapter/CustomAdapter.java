package com.hfad.baseexpandablelistadapter;

/**
 * Created by DEVANG on 6/26/2017.
 */
...
public class CustomAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isLastChild, View view,
        ...
        if (view == null) {
            ...
            view = inf.inflate(R.layout.groups_items, null);
        }

        TextView heading = (TextView) view.findViewById(R.id.tvHeader);
        heading.setText(headerInfo.getName().trim());

        ImageView ivGroupIndicator = (ImageView) view.findViewById(R.id.ivGroupIndicator);
        ivGroupIndicator.setSelected(isLastChild);
